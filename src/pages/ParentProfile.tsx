...
import { BarChart3, TrendingUp, Bell, Camera, User } from "lucide-react";
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="bio" value={expertise} onChange={(e) => setExpertise(e.target.value)} placeholder="Tell us about yourself..." rows={4} />
            </div>
